...
const mockMeetings = [
  {
    ...
    actions: 5,
    summary: [
      "Agreed to prioritize mobile features",
      "Timeline set for Q1 2026 launch",
    ],
  },
  {
    id: "2",
    ...
    actions: 3,
    summary: [
      "New onboarding process approved",
...
const mockTranscripts = [
  {
    ...
    timestamp: "12:45",
    content:
      "I think we should prioritize the mobile app features for Q1 2026. The customer feedback has been overwhelming.",
    meeting: "Q4 Product Roadmap Review",
  ...
  },
  {
    ...
    timestamp: "08:32",
    content:
      "The new onboarding process needs to include a dedicated success manager for enterprise clients.",
    meeting: "Customer Success Strategy",
...
export default function Search() {
  ...
  return (
    <div className="pt-8 pl-8 pr-8 max-w-7xl mx-auto space-y-4">
      {/* Top bar */}
      ...
      {!searchQuery ? (
        <div className="flex flex-col items-center justify-center py-24 px-4">
          ...
          <h2 className="text-2xl font-semibold mb-3">
            Search your meetings and content
          </h2>
          <p className="text-muted-foreground text-center max-w-md mb-6">
            Search across meetings, action items, transcripts, accounts, and
            files. Use operators like "owner:me" or "has:recording" for advanced
            searches.
          </p>
                      ...
                      <div className="space-y-5">
                        ...
                        <div className="pl-5 border-l-2 border-primary/50 py-3">
                          <p className="text-sm leading-relaxed">
                            {transcript.content
                              .split("mobile app features")
                              .map((part, idx, arr) => {
                                if (idx < arr.length - 1) {
                                  return (
                                    <span key={idx}>
                                      {part}
                                      <mark className="bg-primary/20 px-1.5 py-0.5 rounded">
                                        mobile app features
                                      </mark>
                                    </span>
                                  );
