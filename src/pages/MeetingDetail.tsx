...
export default function MeetingDetail() {
    ...
    const [accessLevel, setAccessLevel] = useState<"invited" | "link">(
        "invited"
    );
    ...
    const summary = meeting?.summaryId
        ? mockSummaries[meeting.summaryId]
        : null;
                        ...
                        <CardContent className="flex-1 overflow-hidden">
                            {transcript ? (
                                ...
                                <div className="text-center py-8 text-muted-foreground">
                                    <p>
                                        Transcript not available for this
                                        meeting
                                    </p>
                                </div>
                            )}
            ...
            <Dialog open={exportModalOpen} onOpenChange={setExportModalOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Choose a format to export the meeting summary and
                            transcript
                        </DialogDescription>
                    </DialogHeader>
