...
export default function Home() {
  const todaysMeetings = mockMeetings.filter(m => 
    m.start.toDateString() === new Date().toDateString()
  );
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{upcomingTasks.length} tasks pending</CardDescription>
          </CardHeader>
