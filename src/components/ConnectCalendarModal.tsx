...
const mockGoogleCalendars = [
  { id: "g1", name: "Personal", email: "john.doe@gmail.com", color: "#4285F4" },
  { id: "g2", name: "Work", email: "john.doe@company.com", color: "#0F9D58" },
  { id: "g3", name: "Family", email: "john.doe@gmail.com", color: "#F4B400" },
  { id: "g4", name: "Projects", email: "john.doe@gmail.com", color: "#DB4437" },
];

const mockMicrosoftCalendars = [
  { id: "m1", name: "Calendar", email: "john@microsoft-account.com", color: "#0078D4" },
  { id: "m2", name: "Work Events", email: "john@microsoft-account.com", color: "#7719AA" },
  { id: "m3", name: "Team Calendar", email: "john@microsoft-account.com", color: "#00A4EF" },
];
...
export default function ConnectCalendarModal({
  ...
  const calendars = selectedProvider === "google" ? mockGoogleCalendars : mockMicrosoftCalendars;
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {step === "provider" ? "Connect Calendar" : `Select ${selectedProvider === "google" ? "Google" : "Microsoft"} Calendars`}
          </DialogTitle>
          <DialogDescription>
            {step === "provider"
          ...
          <div className="space-y-3 py-4">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-muted-foreground">Connect your Google calendars</div>
              </div>
            </Button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-muted-foreground">Connect your Microsoft calendars</div>
              </div>
            </Button>
          </div>
        )}
