...
export const MediaPlayer = forwardRef<MediaPlayerHandle, MediaPlayerProps>(
    ({ src, poster, type = "video", className, onTimeUpdate }, ref) => {
        ...
        return (
            <div
                ...
                onMouseLeave={() =>
                    type === "video" && isPlaying && setShowControls(false)
                }
            >
                {type === "video" ? (
                    <video
                    ...
                    <div className="w-full h-60 bg-gradient-to-br from-primary/10 to-accent/5 flex items-center justify-center">
